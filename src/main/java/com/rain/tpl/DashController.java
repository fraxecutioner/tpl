...
public class DashController {
	...
	@RequestMapping(value = "/createLeague", method = RequestMethod.GET)
	public String createL(Model theModel, HttpSession session)
	{
		String createdLeagueYN = "";
	...
	@ModelAttribute("joinedLeagues")
	public List<Team> getleaguePredictList(HttpSession session)
	{
		String ownerId = session.getAttribute("ownerId").toString();
		...
		LeagueDAO obj = new LeagueDAO();
			...
			result = obj.joinedLeagueList(ownerId);
